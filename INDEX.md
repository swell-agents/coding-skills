...
| [creating-block-issues](skills/creating-block-issues/) | Spec Kit project — one "Implement Block X" GitHub issue per `tasks.md` PR-stack block (minimal body, no labels). |
...
| [/coding-skills:block-issues](commands/block-issues.md) | `creating-block-issues` — one "Implement Block X" GitHub issue per Spec Kit `tasks.md` PR-stack block (minimal body, no labels) |
