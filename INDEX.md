...
| [/coding-skills:bootstrap](commands/bootstrap.md) | Append engineering-skills block to canonical `CLAUDE.md`; create `AGENTS.md` as a pointer (refuses to overwrite substantive `AGENTS.md`) |
