---
description: Implement one PR-stack block from Spec Kit `tasks.md` end-to-end — TDD-strict subagent, five-pass review, language-appropriate gates, push, PR, CI fix loop. Use on a Spec Kit project; pass the block name verbatim or `next` to pick the next ready block.
