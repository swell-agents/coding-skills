# ai-native-reviewer-template-sha256: f0f5fb2dc3c2b01a26be610221ccb59467f52981be61c51dfd81885b3e85d3e5
#!/usr/bin/env bash
#
...
# Sync from the plugin via: scripts/sync-ai-native-rubric.sh (stamps SHA + freshness)
#
